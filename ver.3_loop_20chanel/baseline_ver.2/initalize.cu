...
void file_open ( neuron_t *n_MSN_D1, neuron_t *n_MSN_D2, neuron_t *n_FSI, neuron_t *n_STN, neuron_t *n_GPe, neuron_t *n_GPi, neuron_t *n_SNc, neuron_t *n_PTN, neuron_t *n_PTI, neuron_t *n_PSN, neuron_t *n_Th, neuron_t *n_CMPf ){
    ...
    n_MSN_D1 -> file1 = fopen ( "MSN_D1firingrate.dat", "w" );
    n_MSN_D2 -> file1 = fopen ( "MSN_D2firingrate.dat", "w" );
    n_FSI -> file1 = fopen ( "FSIfiringrate.dat", "w" );
    n_STN -> file1 = fopen ( "STNfiringrate.dat", "w" );
    n_GPe -> file1 = fopen ( "GPefiringrate.dat", "w" );
    n_GPi -> file1 = fopen ( "GPifiringrate.dat", "w" );
    n_SNc -> file1 = fopen ( "SNcfiringrate.dat", "w" );
    n_PTN -> file1 = fopen ( "PTNfiringrate.dat", "w" );
    n_PTI -> file1 = fopen ( "PTIfiringrate.dat", "w" );
    n_PSN -> file1 = fopen ( "PSNfiringrate.dat", "w" );
    n_Th -> file1 = fopen ( "Thfiringrate.dat", "w" );
...
void Allocating_Neuron ( neuron_t *n_MSN_D1, neuron_t *n_MSN_D2, neuron_t *n_FSI, neuron_t *n_STN, neuron_t *n_GPe, neuron_t *n_GPi, neuron_t *n_SNc, neuron_t *n_PTN, neuron_t *n_PTI, neuron_t *n_PSN, neuron_t *n_Th, neuron_t *n_CMPf ){
    ...
    cudaMallocManaged ( &n_MSN_D1 -> i_syn, sizeof ( float ) * N_MSN_D1 );
    cudaMallocManaged ( &n_MSN_D1 -> conductance_GABA, sizeof ( float ) * N_MSN_D1 );
    ...
    cudaMallocManaged ( &n_MSN_D2 -> i_syn, sizeof ( float ) * N_MSN_D2 );
    cudaMallocManaged ( &n_MSN_D2 -> conductance_GABA, sizeof ( float ) * N_MSN_D2 );
    ...
    cudaMallocManaged ( &n_FSI -> i_syn, sizeof ( float ) * N_FSI );
    cudaMallocManaged ( &n_FSI -> conductance_GABA, sizeof ( float ) * N_FSI );
    ...
    cudaMallocManaged ( &n_STN -> i_syn, sizeof ( float ) * N_STN );
    cudaMallocManaged ( &n_STN -> conductance_AMPA, sizeof ( float ) * N_STN );
    cudaMallocManaged ( &n_STN -> conductance_NMDA, sizeof ( float ) * N_STN );
    ...
    cudaMallocManaged ( &n_GPe -> i_syn, sizeof ( float ) * N_GPe );
    cudaMallocManaged ( &n_GPe -> conductance_GABA, sizeof ( float ) * N_GPe );
    ...
    cudaMallocManaged ( &n_GPi -> i_syn, sizeof ( float ) * N_GPi );
    cudaMallocManaged ( &n_GPi -> conductance_GABA, sizeof ( float ) * N_GPi );
    ...
    cudaMallocManaged ( &n_SNc -> i_syn, sizeof ( float ) * N_SNc );
    cudaMallocManaged ( &n_SNc -> conductance_DOPA, sizeof ( float ) * N_SNc );
    ...
    cudaMallocManaged ( &n_PTN -> i_syn, sizeof ( float ) * N_PTN );
    cudaMallocManaged ( &n_PTN -> conductance_AMPA, sizeof ( float ) * N_PTN );
    cudaMallocManaged ( &n_PTN -> conductance_NMDA, sizeof ( float ) * N_PTN );
    ...
    cudaMallocManaged ( &n_PTI -> i_syn, sizeof ( float ) * N_PTI );
    cudaMallocManaged ( &n_PTI -> conductance_GABA, sizeof ( float ) * N_PTI );
    ...
    cudaMallocManaged ( &n_PSN -> conductance_AMPA, sizeof ( float ) * N_PSN );
    cudaMallocManaged ( &n_PSN -> conductance_NMDA, sizeof ( float ) * N_PSN );
    ...
    cudaMallocManaged ( &n_Th -> i_syn, sizeof ( float ) * N_Th );
    cudaMallocManaged ( &n_Th -> conductance_AMPA, sizeof ( float ) * N_Th );
    cudaMallocManaged ( &n_Th -> conductance_NMDA, sizeof ( float ) * N_Th );
    ...
    cudaMallocManaged ( &n_CMPf -> conductance_AMPA, sizeof ( float ) * N_CMPf );
    cudaMallocManaged ( &n_CMPf -> conductance_NMDA, sizeof ( float ) * N_CMPf );
...
void initalize_Neuron ( neuron_t *n_MSN_D1, neuron_t *n_MSN_D2, neuron_t *n_FSI, neuron_t *n_STN, neuron_t *n_GPe, neuron_t *n_GPi, neuron_t *n_SNc, neuron_t *n_PTN, neuron_t *n_PTI, neuron_t *n_PSN, neuron_t *n_Th, neuron_t *n_CMPf ){
    ...
    for ( int i = 0; i < N_STN; i++ ){
        ...
        n_STN -> i_syn[ i ] = 0;
        n_STN -> conductance_AMPA[ i ] = 0;
        n_STN -> conductance_NMDA[ i ] = 0;
        n_STN -> s[ i ] = false;
        n_STN -> ts[ i ] = 1000;
        n_STN -> refr[ i ] = 0;
        n_STN -> counter[ i ] = 0;
    ...
    for ( int i = 0; i < N_PTN; i++ ){
        ...
        n_PTN -> i_syn[ i ] = 0;
        n_PTN -> conductance_AMPA[ i ] = 0;
        n_PTN -> conductance_NMDA[ i ] = 0;
        n_PTN -> s[ i ] = false;
        n_PTN -> ts[ i ] = 1000;
        n_PTN -> refr[ i ] = 0;
        n_PTN -> counter[ i ] = 0;
    ...
    for ( int i = 0; i < N_PSN; i++ ){
        ...
        n_PSN -> conductance_AMPA[ i ] = 0;
        n_PSN -> conductance_NMDA[ i ] = 0;
        n_PSN -> s[ i ] = false;
        n_PSN -> ts[ i ] = 1000;
        n_PSN -> counter[ i ] = 0;
    }
    ...
    for ( int i = 0; i < N_Th; i++ ){
        ...
        n_Th -> i_syn[ i ] = 0;
        n_Th -> conductance_AMPA[ i ] = 0;
        n_Th -> conductance_NMDA[ i ] = 0;
        n_Th -> s[ i ] = false;
        n_Th -> ts[ i ] = 1000;
        n_Th -> refr[ i ] = 0;
        n_Th -> counter[ i ] = 0;
    ...
    for ( int i = 0; i < N_CMPf; i++ ){
        ...
        n_CMPf -> conductance_AMPA[ i ] = 0;
        n_CMPf -> conductance_NMDA[ i ] = 0;
        n_CMPf -> s[ i ] = false;
        n_CMPf -> ts[ i ] = 1000;
        n_CMPf -> counter[ i ] = 0;
    }
